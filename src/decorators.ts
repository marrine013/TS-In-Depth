export function sealed(param: string) /* :  (constructor: Function) => void */ {
...
export function logger<TFunction extends Function>(constructor: TFunction): TFunction {
    ...
    newConstructor.prototype = Object.create(
        constructor.prototype,
    ); /* добавить изменения к существующему классу, а не переписать его */
