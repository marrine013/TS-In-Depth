...
export async function logSearchResults(category: Category) /* всегда возвращает промис */ {
    const titles = await getBooksByCategoryPromise(category); // без await тип переменной Promis
